...
{Colors.GREEN}{Colors.BOLD}
    ...
    ╚══════╝╚═╝  ╚═╝    ╚══════╝╚═╝╚═╝
       ...
       Advanced ZIP Suite  — Password Engine v3 (Fixed)
            ...
            while True:
                ...
                for enc in ENCODINGS:
                    ...
                    try:
                        ...
                        # FIXED: test with read() instead of extractall()
                        ...
                        # "Bad password for file" → wrong password, try next encoding
                        err_str = str(e).lower()
                        if 'password' in err_str or 'bad' in err_str or 'crc' in err_str:
                            continue
                        # Other RuntimeError → skip this encoding
                        continue
